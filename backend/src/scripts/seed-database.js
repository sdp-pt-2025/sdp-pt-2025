...
const sampleData = {
    ...
    studyGroups: [
        {
            ...
            description:
                "Weekly study group for COMS3011 Algorithms course. We focus on problem-solving and exam preparation.",
            module: "COMS3011",
            ...
            schedule: {
                ...
                time: "14:00",
                duration: 120,
                nextSession: admin.firestore.Timestamp.fromDate(
        ...
        },
        {
            ...
            description:
                "Study group for MATH101 Calculus. We meet twice a week to work through problems and prepare for tests.",
            module: "MATH101",
            topic: "Calculus",
            createdBy: "user2",
    ...
    groupMessages: [
        {
            ...
            senderName: "John Doe",
            message:
                "Hey everyone! Looking forward to our study session tomorrow. I've prepared some practice problems on sorting algorithms.",
            messageType: "text",
            attachments: [],
            replyTo: null,
            edited: false,
        ...
        },
        {
            ...
            message:
                "Great! I've been working on the merge sort implementation. Can we go through it together?",
            messageType: "text",
            attachments: [],
            replyTo: "msg1",
            edited: false,
    ...
    studySessions: [
        ...
        },
        {
            ...
            endTime: admin.firestore.Timestamp.fromDate(
                new Date(Date.now() - 1 * 24 * 60 * 60 * 1000 + 90 * 60 * 1000),
            ),
            location: {
                type: "home",
    ...
    progressTracking: [
        {
            ...
            studyHours: 8.5,
            lastStudied: admin.firestore.Timestamp.fromDate(
                new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
            ),
            difficulty: 3,
            confidence: 4,
    ...
    notifications: [
        ...
        },
        {
            ...
            read: true,
            readAt: admin.firestore.Timestamp.fromDate(
    ...
    courseworkFiles: [
        {
            ...
            downloadUrl:
                "https://storage.googleapis.com/sd2025law.appspot.com/coursework/user1/assignment1.pdf",
            uploadedBy: "user1",
            ...
            updatedAt: admin.firestore.FieldValue.serverTimestamp(),
            downloadCount: 3,
            lastDownloadedAt: admin.firestore.Timestamp.fromDate(
                new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
            ),
        },
    ],
    ...
    bugs: [
        {
            ...
            description:
                "The weather widget on the dashboard shows cached data and doesn't refresh automatically. Users have to manually refresh the page to see updated weather information.",
            severity: "medium",
            category: "ui",
            status: "open",
            priority: 5,
            ...
            expectedBehavior:
                "Weather data should update automatically every 5 minutes",
...
async function seedDatabase() {
    try {
        ...
        console.log(
            `📊 Seeded ${sampleData.groupMessages.length} group messages`,
        );
        console.log(
            `📊 Seeded ${sampleData.studySessions.length} study sessions`,
        );
        console.log(
            `📊 Seeded ${sampleData.progressTracking.length} progress records`,
        );
        console.log(
            `📊 Seeded ${sampleData.notifications.length} notifications`,
        );
        console.log(
            `📊 Seeded ${sampleData.courseworkFiles.length} coursework files`,
        );
