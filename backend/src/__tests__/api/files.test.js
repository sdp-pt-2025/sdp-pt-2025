...
describe('Files API', () => {
  ...
  describe('GET /api/files', () => {
    it('should return user files with pagination', async () => {
      ...
      admin.firestore().collection().where().orderBy().limit().offset().get
    ...
    it('should filter files by course code', async () => {
      ...
      admin.firestore().collection().where().where().orderBy().limit().offset().get
        .mockResolvedValue(mockSnapshot);
  ...
  describe('PUT /api/files/:id', () => {
    it('should update file metadata', async () => {
      ...
      admin.firestore().collection().doc().get
        .mockResolvedValueOnce(mockDoc) // First call for permission check
  ...
  describe('GET /api/files/search', () => {
    it('should search files by query', async () => {
      ...
      admin.firestore().collection().where().get.mockResolvedValue(mockSnapshot);
